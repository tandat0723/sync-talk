...
export function SignupForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input type="text" id="email" placeholder="mess@gmail.com" {...register('email')} />
                {errors.email && (
                  <p className="text-destructive text-sm">
      ...
      <div className="text-xs text-balance px-6 text-center *:[a]:hover:text-primary 
      text-muted-foreground *:[a]:underline *:[a]:underline-offset-4"
      >
        Bằng cách nhấp vào "Tiếp tục", bạn đồng ý với các điều khoản của chúng tôi{" "}
